<div class="col-xl-3 col-sm-6 col-lg-4 {{ @$key }}">
    <div class="wsus__product_item">
        ...
        <ul class="wsus__single_pro_icon">
            ...
            <li><a href="#" class="add-to-compare" data-product-id="{{$product->id}}" data-product-name="{{$product->name}}" data-product-image="{{asset($product->thumb_image)}}" data-product-price="{{$settings->currency_icon}}{{checkDiscount($product) ? $product->offer_price : $product->price}}"><i class="fas fa-random"></i></a></li>
        </ul>
