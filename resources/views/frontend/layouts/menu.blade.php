            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        <li><a class="{{setActive(['home'])}}" href="{{url('/')}}">{{ __('Home') }}</a></li>
                        
                        <li><a class="{{setActive(['products.index'])}}" href="{{route('products.index')}}">{{ __('Shop') }}</a></li>
                        
                        <li><a class="{{setActive(['vendor.index'])}}" href="{{route('vendor.index')}}">{{ __('Sellers') }}</a></li>
                        
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">{{ __('Today\'s Special') }}</a></li>
                        
                        <li>
                            <a href="#">{{ __('Deals') }} <i class="fas fa-angle-down"></i></a>
                            <ul class="wsus_menu_cat_droapdown">
                                <li><a href="{{route('flash-sale')}}">{{ __('Flash Sales') }}</a></li>
                                <li><a href="#">{{ __('Clearance') }}</a></li>
                                <li><a href="#">{{ __('Season Offers') }}</a></li>
                            </ul>
                        </li>
                        
                        <li><a class="{{setActive(['blog'])}}" href="{{route('blog')}}">{{ __('News') }}</a></li>
                        
                        <li><a class="{{setActive(['about'])}}" href="{{route('about')}}">{{ __('About') }}</a></li>
                        
                        <li><a class="{{setActive(['contact'])}}" href="{{route('contact')}}">{{ __('Contact') }}</a></li>
                    </ul>
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('vendor.dashboard')}}">Seller Dashboard</a></li>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <ul>
                        ...
                        <li><a href="{{route('vendor.index')}}">{{ __('Sellers') }}</a></li>
                        <li><a href="{{route('flash-sale')}}">{{ __('Today\'s Special') }}</a></li>
                        
                        <li>
                            <a href="#" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#deals-collapse" aria-expanded="false" aria-controls="deals-collapse">
                                {{ __('Deals') }}
                            </a>
                            <div id="deals-collapse" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample2">
                                <div class="accordion-body">
                                    <ul>
                                        <li><a href="{{route('flash-sale')}}">{{ __('Flash Sales') }}</a></li>
                                        <li><a href="#">{{ __('Clearance') }}</a></li>
