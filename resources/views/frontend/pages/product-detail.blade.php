                           ...
                           <p class="description">{!! $product->short_description !!}</p>
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    <li><button type="submit" class="add_cart" href="#">{{__('add to cart')}}</button></li>

                                    <li><a style="border: 1px solid gray;
                                        padding: 7px 11px;
                                        border-radius: 100%;" href="javascript:;" class="add_to_wishlist" data-id="{{$product->id}}" title="{{__('Add to Wishlist')}}"><i class="fal fa-heart"></i></a></li>

                                    <li>
                                        <a href="#" style="border: 1px solid gray;
                                        padding: 7px 11px;
                                        border-radius: 100%;" class="add-to-compare" data-product-id="{{$product->id}}" data-product-name="{{$product->name}}" data-product-image="{{asset($product->thumb_image)}}" data-product-price="{{$settings->currency_icon}}{{checkDiscount($product) ? $product->offer_price : $product->price}}" title="{{__('Add to Compare')}}">
                                    ...
                                    <li>
                                        ...
                                        padding: 7px 11px;
                                        margin-left: 7px;
                                        border-radius: 100%; background-color: #0088cc" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" title="{{__('Ask Question')}}">
