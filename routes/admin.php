...
use App\Http\Controllers\backend\ChapaController;
...
Route::put('languages/{language}/translations', [LanguageController::class, 'updateTranslations'])->name('languages.updateTranslations');
